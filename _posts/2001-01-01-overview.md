...
It creates and manipulates SVG ([scalable vector graphics][svg]), which is the open standard for vector graphics on the web. Pablo focusses on simplicity and performance, targeting modern browsers for both desktop and mobile.
