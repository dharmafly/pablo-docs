...
&#8202;<span class="project-name">Pablo</span>  is a lightweight, expressive JavaScript library for creating and manipulating collections (arrays) of [SVG][svg] elements, to generate interactive drawings. Like [Raphaël][raphael] + [jQuery][jquery] + [Underscore][_]. _In less than 3KB._
