var SuryaFruit = (function(){
    ...
    Symbol.prototype = {
        ...
        randomize: function(){
            ...
            this.scale = Math.round(Floaters.selectInRange(this.importance, settings.scaleMin, settings.scaleMax));
        ...
        createDom: function(){
            ...
            this.dom = this.root.image().link('symbols/surya-fruit.svg');
            return this;
        },
